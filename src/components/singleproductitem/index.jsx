...
const SingleProduct = ({ producttile }) => {
  const navigate = useNavigate();

 function handlenavigate(getcurrentdetails) {
  navigate(`/product-details/${getcurrentdetails}`);
}
  ...
  return (
    <div className='relative group border border-cyan-700 p-6 cursor-pointer'>
      ...
      <button
        onClick={() => handlenavigate(producttile?.id)}
